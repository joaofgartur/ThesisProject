...
if __name__ == '__main__':
    algorithms = ['Massaging', 'Reweighing', 'DisparateImpactRemover', 'AIF360LearningFairRepresentations', 'MultivalueLGAFFS' ,'LGAFFS', 'PermutationGeneticAlgorithm']

    for algorithm in algorithms:
        input_folder = f"results_1_iteration_adult_21_05_2024/{algorithm}"
