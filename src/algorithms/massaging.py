...
def compute_m(dataset: Dataset, sensitive_attribute: str) -> int:
    """
...
def compute_class_probabilities(dataset: Dataset, learning_settings: dict) -> np.ndarray:
    """
    ...
    if _TRAIN_SIZE_KEY not in learning_settings or _TEST_SIZE_KEY not in learning_settings:
...
def ranking(dataset: Dataset, sensitive_attribute: str, learning_settings: dict) -> Tuple[np.array, np.array]:
    """
...
def massaging(dataset: Dataset, sensitive_attribute: str, learning_settings: dict) -> Dataset:
    """
