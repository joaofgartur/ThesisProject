...
def compute_weights(dataset: Dataset, sensitive_attribute: str) -> pd.DataFrame:
    """
    ...
    for permutation in permutations:
        ...
        prob_expected = simple_probability(data, sensitive_attribute, value) * simple_probability(data, outcome_column,
                                                                                                  outcome)
...
def reweighing(dataset: Dataset, sensitive_attribute: str) -> Dataset:
    """
    ...
    weights = compute_weights(dataset, sensitive_attribute)
